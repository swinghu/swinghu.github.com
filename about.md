...
<dl class="aboutDl">
	...
	<dd><strong>weibo:</strong><a href="http://weibo.com/http://weibo.com/u/1680100140" target="_blank">@BarretLee</a></dd>
	...
	<dd><strong>自述:</strong>WHUer,特别喜欢钻研新技术，对服务端 (NodeJS) 、linux，服务器端开发、以及数据库 (MongoDB) 知识很感兴趣。行动方式是底层再底层思考，创新再创新实践。</dd>
